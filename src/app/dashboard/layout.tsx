  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row">
        ...
        {/* Sidebar */}
        <aside className={`
          fixed lg:relative inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-green-800 to-green-900 text-white
          transform transition-transform duration-300 lg:transform-none overflow-y-auto max-h-screen flex-shrink-0
        ...
        `}>
          ...
          <nav className="p-4 space-y-1 pb-4">
            {navItems.map((item) => {
          ...
          <div className="relative mt-auto p-4 border-t border-green-700">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {/* Top navigation */}
          <header className="bg-white border-b border-gray-100 shadow-sm px-4 sm:px-6 py-4 sticky top-0 z-30 flex-shrink-0">
              ...
              <div className="flex-1 max-w-md mx-4 hidden sm:block">
                <div className="relative">
                  ...
                  <svg className="absolute left-3 top-3 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 70 0 14 0z" />
                  </svg>
                </div>
              </div>
