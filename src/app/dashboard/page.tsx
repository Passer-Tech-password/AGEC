      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="border-2 border-transparent hover:border-green-200 shadow-lg transition-all">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <div className="w-12 h-12 sm:w-14 h-14 bg-gradient-to-br from-green-100 to-green-200 rounded-2xl flex items-center justify-center">
              <Briefcase className="w-5 h-5 sm:w-7 h-7 text-green-700" />
            </div>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-2 border-transparent hover:border-amber-200 shadow-lg transition-all">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <div className="w-12 h-12 sm:w-14 h-14 bg-gradient-to-br from-amber-100 to-amber-200 rounded-2xl flex items-center justify-center">
              <TrendingUp className="w-5 h-5 sm:w-7 h-7 text-amber-700" />
            </div>
          </CardHeader>
          <CardContent>
            <div className="text-2xl sm:text-3xl font-bold text-gray-900">{formatCurrency(totalEarnings)}</div>
        ...
        <Card className="border-2 border-transparent hover:border-green-200 shadow-lg transition-all">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <div className="w-12 h-12 sm:w-14 h-14 bg-gradient-to-br from-green-700 to-green-800 rounded-2xl flex items-center justify-center">
              <Wallet className="w-5 h-5 sm:w-7 h-7 text-white" />
            </div>
          </CardHeader>
          <CardContent>
            <div className="text-2xl sm:text-3xl font-bold text-gray-900">{formatCurrency(availableBalance)}</div>
        ...
        <Card className="border-2 border-transparent hover:border-emerald-200 shadow-lg transition-all">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <div className="w-12 h-12 sm:w-14 h-14 bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-2xl flex items-center justify-center">
              <Users className="w-5 h-5 sm:w-7 h-7 text-emerald-700" />
            </div>
          </CardHeader>
          <CardContent>
            <div className="text-2xl sm:text-3xl font-bold text-gray-900">{formatCurrency(referralEarnings)}</div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <Link href="/dashboard/investments" className="w-full">
              <Button className="w-full h-auto py-5 sm:py-7 flex-col gap-3 bg-gradient-to-br from-green-700 to-green-800 hover:from-green-800 hover:to-green-900 text-white shadow-lg shadow-green-700/20 rounded-2xl">
                <Briefcase className="w-8 h-8" />
                <span className="font-semibold text-base sm:text-lg">Make Investment</span>
              </Button>
            </Link>
            <Link href="/dashboard/wallet" className="w-full">
              <Button className="w-full h-auto py-5 sm:py-7 flex-col gap-3 bg-gradient-to-br from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white shadow-lg shadow-amber-500/20 rounded-2xl">
                ...
                <span className="font-semibold text-base sm:text-lg">Deposit Funds</span>
              </Button>
            </Link>
